...
public class Stacker extends Subsystem {
    private final static double UPPER_GATE_OPEN = 0.3;
    private final static double UPPER_GATE_CLOSE= 0.0;
    private final static double LOWER_GATE_OPEN = 0.6;
    private final static double LOWER_GATE_CLOSE= 1.0;
