...
public class RobotMap {
	...
	LiveWindow.addActuator("Shooter", "TriggerMotor", (Victor) shooterTriggerMotor);
        ...
        shooterTriggerEncoder = new Encoder(1, 5, 1, 6, false, EncodingType.k4X);
	LiveWindow.addSensor("Shooter", "TriggerEncoder", shooterTriggerEncoder);
        ...
        shooterTriggerPID = new PIDController(1.0, 0.0, 0.0, 0.0, shooterTriggerEncoder, shooterTriggerMotor, 0.02);
	...
	LiveWindow.addActuator("Shooter", "TiltMotor", (Victor) shooterTiltMotor);
        ...
        shooterTiltEncoder = new Encoder(1, 7, 1, 8, false, EncodingType.k4X);
	LiveWindow.addSensor("Shooter", "TiltEncoder", shooterTiltEncoder);
        ...
        shooterTiltPID = new PIDController(1.0, 0.0, 0.0, 0.0, shooterTiltEncoder, shooterTiltMotor, 0.02);
