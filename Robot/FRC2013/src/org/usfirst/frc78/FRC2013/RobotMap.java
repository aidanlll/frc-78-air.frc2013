...
public class RobotMap {
    ...
    public static AnalogChannel tiltTiltPot;
	...
	LiveWindow.addActuator("Shooter", "FrontMotor", (Victor) shooterFrontMotor);
        ...
        shooterFrontEncoder = new Encoder(2, 1, 2, 2, false, EncodingType.k1X);
	...
	LiveWindow.addActuator("Shooter", "RearMotor", (Victor) shooterRearMotor);
        ...
        shooterRearEncoder = new Encoder(2, 3, 2, 4, false, EncodingType.k1X);
	...
	LiveWindow.addActuator("Target", "SpotLight", targetSpotLight);
        ...
        tiltTiltPot = new AnalogChannel(1, 2);
	LiveWindow.addSensor("Tilt", "TiltPot", tiltTiltPot);
        
        tiltTiltMotor = new Victor(2, 9);
	LiveWindow.addActuator("Tilt", "TiltMotor", (Victor) tiltTiltMotor);
