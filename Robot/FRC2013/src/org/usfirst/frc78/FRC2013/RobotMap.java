...
public class RobotMap {
    ...
    public static AnalogChannel tiltPot;
    public static DigitalInput tiltUpperLimit;
    public static DigitalInput tiltLowerLimit;
	...
	LiveWindow.addSensor("Chassis", "LeftEncoder", chassisLeftEncoder);
        chassisLeftEncoder.setDistancePerPulse(0.00676651);
	...
	LiveWindow.addSensor("Chassis", "RightEncoder", chassisRightEncoder);
        chassisRightEncoder.setDistancePerPulse(0.00676651);
	...
	LiveWindow.addActuator("Tilt", "Motor", (Victor) tiltMotor);
        ...
        tiltEncoder = new Encoder(1, 1, 1, 2, true, EncodingType.k4X);
	LiveWindow.addSensor("Tilt", "Encoder", tiltEncoder);
        tiltEncoder.setDistancePerPulse(0.022857);
        tiltEncoder.setPIDSourceParameter(PIDSourceParameter.kDistance);
        tiltEncoder.start();
        tiltPot = new AnalogChannel(1, 2);
	LiveWindow.addSensor("Tilt", "Pot", tiltPot);
        
        tiltUpperLimit = new DigitalInput(2, 1);
	LiveWindow.addSensor("Tilt", "UpperLimit", tiltUpperLimit);
        
        tiltLowerLimit = new DigitalInput(2, 3);
	LiveWindow.addSensor("Tilt", "LowerLimit", tiltLowerLimit);
