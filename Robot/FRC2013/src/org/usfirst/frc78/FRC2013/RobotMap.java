...
public class RobotMap {
    ...
    public static Encoder shooterTriggerEncoder;
    public static PIDController shooterTriggerPID;
    ...
    public static void init() {
        ...
        chassisLeftEncoder = new Encoder(1, 11, 1, 12, false, EncodingType.k1X);
	LiveWindow.addSensor("Chassis", "LeftEncoder", chassisLeftEncoder);
        ...
        chassisRightEncoder = new Encoder(1, 13, 1, 14, false, EncodingType.k1X);
	...
	LiveWindow.addActuator("Chassis", "RRmotor", (Victor) chassisRRmotor);
        ...
        shooterFrontMotor = new Victor(1, 5);
	LiveWindow.addActuator("Shooter", "FrontMotor", (Victor) shooterFrontMotor);
        
        shooterFrontEncoder = new Encoder(1, 1, 1, 2, false, EncodingType.k4X);
	LiveWindow.addSensor("Shooter", "FrontEncoder", shooterFrontEncoder);
        ...
        shooterFrontPID = new PIDController(3.33E-4, 0.0, 0.0, 0.0, shooterFrontEncoder, shooterFrontMotor, 0.02);
	LiveWindow.addActuator("Shooter", "FrontPID", shooterFrontPID);
        ...
        shooterRearMotor = new Victor(1, 6);
	LiveWindow.addActuator("Shooter", "RearMotor", (Victor) shooterRearMotor);
        
        shooterRearEncoder = new Encoder(1, 3, 1, 4, false, EncodingType.k4X);
	LiveWindow.addSensor("Shooter", "RearEncoder", shooterRearEncoder);
        ...
        shooterRearPID = new PIDController(1.0E-4, 0.0, 0.0, 0.0, shooterRearEncoder, shooterRearMotor, 0.02);
	LiveWindow.addActuator("Shooter", "RearPID", shooterRearPID);
        ...
        shooterTriggerMotor = new Victor(1, 7);
	LiveWindow.addActuator("Shooter", "TriggerMotor", (Victor) shooterTriggerMotor);
        
        shooterTriggerEncoder = new Encoder(1, 5, 1, 6, false, EncodingType.k1X);
	LiveWindow.addSensor("Shooter", "TriggerEncoder", shooterTriggerEncoder);
        shooterTriggerEncoder.setDistancePerPulse(1.40625);
        shooterTriggerEncoder.setPIDSourceParameter(PIDSourceParameter.kDistance);
        shooterTriggerEncoder.start();
        shooterTriggerPID = new PIDController(0.4, 0.0, 0.0, 0.0, shooterTriggerEncoder, shooterTriggerMotor, 0.02);
	LiveWindow.addActuator("Shooter", "TriggerPID", shooterTriggerPID);
        shooterTriggerPID.setContinuous(true); shooterTriggerPID.setAbsoluteTolerance(2.5); 
        shooterTriggerPID.setInputRange(0.0, 360.0);
        shooterTriggerPID.setOutputRange(-1.0, 1.0);        
        shooterTiltMotor = new Victor(1, 8);
	LiveWindow.addActuator("Shooter", "TiltMotor", (Victor) shooterTiltMotor);
        
        shooterTiltEncoder = new Encoder(1, 7, 1, 8, false, EncodingType.k1X);
	LiveWindow.addSensor("Shooter", "TiltEncoder", shooterTiltEncoder);
        shooterTiltEncoder.setDistancePerPulse(1.40625);
        shooterTiltEncoder.setPIDSourceParameter(PIDSourceParameter.kDistance);
        shooterTiltEncoder.start();
        shooterTiltPID = new PIDController(0.4, 0.0, 0.0, 0.0, shooterTiltEncoder, shooterTiltMotor, 0.02);
