...
public class OI {
    ...
    public JoystickButton tiltToBalance;
    ...
    public OI() {
        ...
        tiltToBalance = new JoystickButton(driverJoystick, 9);
        tiltToBalance.whileHeld(new TiltMoveToBalance());
        ...
        SmartDashboard.putData("Shoot5ptFour", new Shoot5ptFour());
        ...
        SmartDashboard.putData("TiltMoveToBalance", new TiltMoveToBalance());
