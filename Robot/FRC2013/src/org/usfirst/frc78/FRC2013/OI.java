...
public class OI {
    ...
    public JoystickButton shooterOnBut;
    public JoystickButton shooterOffBut;
    public JoystickButton chamberFrisbee;
    public JoystickButton triggerBut;
    ...
    public OI() {
        ...
        tilt5ptAngleBut.whileHeld(new LoadAndShoot5ptOne());
        ...
        tiltToBalanceBut = new JoystickButton(driverJoystick, 9);
        tiltToBalanceBut.whileHeld(new TiltMoveToBalance());
        triggerBut = new JoystickButton(driverJoystick, 7);
        triggerBut.whenPressed(new ShooterPullTrigger());
        chamberFrisbee = new JoystickButton(driverJoystick, 3);
        chamberFrisbee.whenPressed(new StackChamberFrisbee());
        shooterOffBut = new JoystickButton(driverJoystick, 1);
        shooterOffBut.whenReleased(new ShooterStopWheels());
        shooterOnBut = new JoystickButton(driverJoystick, 1);
        shooterOnBut.whenPressed(new ShooterStartWheels());
