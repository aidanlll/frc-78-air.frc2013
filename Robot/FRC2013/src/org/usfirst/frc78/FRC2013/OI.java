...
public class OI {
    ...
    public JoystickButton triggerOn;
    ...
    public OI() {
        ...
        shootContinuousButton = new JoystickButton(shooterJoystick, 2);
        ...
        shooterOn.whileHeld(new RunShooter());
        triggerOn = new JoystickButton(driverJoystick, 7);
        triggerOn.whileHeld(new RunTrigger());
        ...
        SmartDashboard.putData("RunTrigger", new RunTrigger());
    ...
    public boolean getTiggerMoveSw() {
