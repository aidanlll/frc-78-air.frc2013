...
public class OI {
    ...
    public OI() {
        ...
        turn270 = new JoystickButton(driverJoystick, 4);
        turn270.whileHeld(new AutoTurn270());
        turn90 = new JoystickButton(driverJoystick, 3);
        turn90.whileHeld(new AutoTurn90());
        chamberFrisbee = new JoystickButton(driverJoystick, 2);
